...
const LHDesktopConfig = require('lighthouse/lighthouse-core/config/desktop-config');
...
const checkLightHouse = async () => {
    ...
    const runnerResult = await lighthouse.default(lighthouseConfig.urls[0], options, LHDesktopConfig);
