...
try {
    ...
    ci.sh('export FORMS_DOCUMENT_SERVICE=forms-docservice-java:8080 && echo "Environment variable set"');
    // Start CQ
    ci.sh(`./qp.sh -v start --id author --runmode author --port 4502 --qs-jar /home/circleci/cq/author/cq-quickstart.jar \
            ...
            --vm-options \\\"-Xmx4096m -XX:MaxPermSize=1024m -Djava.awt.headless=true -javaagent:${process.env.JACOCO_AGENT}=destfile=crx-quickstart/jacoco-it.exec -DFORMS_DOCUMENT_SERVICE=forms-docservice-java:8080\\\" \
            ${preleaseOpts}`);
});
