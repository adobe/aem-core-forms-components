...
* Selecting a date input, using HTML5 input type date.

### Use Object
The Form Text component uses the `com.adobe.cq.forms.core.components.models.form.DatePicker` Sling Model for its Use-object.

### Edit Dialog Properties
The following properties are written to JCR for this Form DatePicker component and are expected to be available as `Resource` properties:
...
It also provides a `core.forms.components.datepicker.v1.editor` editor client library category that includes
