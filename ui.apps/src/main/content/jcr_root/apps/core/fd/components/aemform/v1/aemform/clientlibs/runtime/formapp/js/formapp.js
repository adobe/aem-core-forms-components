...
(function() {
    var guideBridge, aemFormConfig, aemFormIframeSelector = ".cmp-aemform__iframecontent", aemFormNonIframeSelector = ".cmp-aemform__content", httpEval = function(
            url) {
        var response = $.ajax({
            url : url,
            type : "get",
    ...
    onSubmit = function(guideResultObj) {
        ...
        if (aemFormConfig.thankyouConfig === "page") {
            var inlineSubmitTypeWithoutIframe = aemFormConfig.useIframe === "false"
                    && aemFormConfig.submitType === "inline", pageRefreshSubmitTypeWithIframe = aemFormConfig.useIframe === "true"
        ...
        var submitConfig = {}, renderConfig = {}, formElement, inlineSubmitTypeWithoutIframe = aemFormConfig.useIframe === "false"
                && aemFormConfig.submitType === "inline", pageRefreshSubmitTypeWithIframe = aemFormConfig.useIframe === "true"
                && aemFormConfig.submitType === "pageRefresh";
