...
It should be added to a relevant site client library using the `embed` property. The `runtime` client library also include a widget which helps in implementation of `displayFormat` and `editFormat`.
