...
(function($, DatePicker) {
    ...
    window.af.formsRuntime.view.FormContainer = class FormContainer {
        constructor(params) {
        ...
        initialiseElementView(element, tagName, clazz) {
            ...
            formField.setOptions(window.af.formsRuntime.view.utils.readData(element, clazz));
            formField.subscribe();
...
})(jQuery, window.af.formsRuntime.view.DatePicker);
