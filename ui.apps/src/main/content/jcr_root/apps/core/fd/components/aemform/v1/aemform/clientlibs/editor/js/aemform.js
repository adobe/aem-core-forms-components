...
/* global jQuery, Coral */
(function($, Coral) {
    var iframeOptionSelector = ".cmp-aemform--editor-useiframe", enableFocusSelector = ".cmp-aemform--editor-enablefocusonfirstfield", thankYouConfigSelector = "coral-radio[name='./thankyouConfig']", submitTypeSelector = ".cmp-aemform--editor-submitType", getToggleElement = function(
            elementId) {
        ...
        var showIds = $(el).attr("data-show"), hideIds = $(el).attr("data-hide");
        ...
        var $el = e ? $(e.target) : $(iframeOptionSelector), isChecked = $el.attr("checked") === "checked" ? true : false, isPageSelected = false;
