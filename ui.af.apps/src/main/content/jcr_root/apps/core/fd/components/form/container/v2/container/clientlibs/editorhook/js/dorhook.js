...
(function (ns, document) {
    ...
    if(Granite && Granite.isRDE){
        toolBar.addEventListener('DOMNodeInserted',() => {
            dorPreviewElement = document.querySelector(`[data-action="dorPreview"][icon="printPreview"]`);
            
            if (dorPreviewElement && !dorPreviewElement.disabled){
                dorPreviewElement.disabled = true;

                dorPreviewElement.removeAttribute("title");
                var wrapper = document.createElement('span');
                wrapper.setAttribute("class","dor-preview-button-wrapper");
                dorPreviewElement.parentNode.insertBefore(wrapper, dorPreviewElement);
                wrapper.appendChild(dorPreviewElement);
                ...
                dor_message_tooltip.set({
                    ...
                    variant: "warning",
                    id:"rdeWarningToolTip"
                });
                wrapper.parentElement.append(dor_message_tooltip);
            }
        });
    }
