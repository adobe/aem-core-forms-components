...
-->
Adaptive Form Next Button (v1)
====
Adaptive Form Next Button component written in HTL.

## Features

* Accessibility friendly 
* Custom description/tooltip for help
* Out of the box setFocus rule in the button to set the focus on the next active item of the parent panel
* Allows replacing this component with other component (as mentioned below).

### Use Object
The Next button component uses the `com.adobe.cq.forms.core.components.models.form.Button` Sling Model for its Use-object.

### Edit Dialog Properties
The following properties are written to JCR for this next button component and are expected to be available as `Resource` properties:
...
### Sling Property
The button has a default property of `buttonType` set to `next` which is used to describe the type of the button.
