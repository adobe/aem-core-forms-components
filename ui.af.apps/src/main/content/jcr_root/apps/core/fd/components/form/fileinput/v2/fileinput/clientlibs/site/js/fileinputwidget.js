...
if (typeof window.FileInputWidgetV2 === 'undefined') {
    window.FileInputWidgetV2 = class {
        ...
        #handleFilePreview (event){
            ...
            if (index !== -1) {
                ...
                if(fileUrl)  {
                    ...
                    FileInputWidgetV2.previewFile.apply(this, [null, {"fileUrl" : fileUrl}]);
                } else {
                    // todo: add support here
                    //let previewFileObjIdx = this._getFileObjIdx(index);
                    let previewFile = this.#fileArr[index]?.data;
                    let objectUrl = FileInputWidgetV2.previewFileUsingObjectUrl(previewFile);
                    if (objectUrl) {
            ...
            if (!this.#isFileUpdate) {
                ...
                if (typeof files !== "undefined") {
                    ...
                    Array.from(files).forEach(function (file, fileIndex) {
                        ...
                        } else if (!FileInputWidgetV2.isValid(currFileName)) {
