...
import com.adobe.cq.forms.core.components.models.form.Header;
...
@Model(
    ...
    resourceType = { FormConstants.RT_FD_FORM_HEADER_V1 })
@Exporter(
    name = ExporterConstants.SLING_MODEL_EXPORTER_NAME,
    extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class HeaderImpl extends AbstractFieldImpl implements Header {
