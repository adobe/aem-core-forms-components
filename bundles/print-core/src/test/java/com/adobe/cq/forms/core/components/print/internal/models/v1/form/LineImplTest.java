...
import com.adobe.cq.forms.core.components.models.form.print.Line;
...
public class LineImplTest {
    ...
    private static final String BASE = "/form/line";
    private static final String CONTENT_ROOT = "/content";
    private static final String PATH_LINE = CONTENT_ROOT + "/line";
    ...
    void testJSONExport() throws Exception {
        Line line = Utils.getComponentUnderTest(PATH_LINE, Line.class, context);
        String expectedJsonResource = Utils.getTestExporterJSONPath(BASE, PATH_LINE);
        InputStream modeInputStream = Utils.getJson(line);
