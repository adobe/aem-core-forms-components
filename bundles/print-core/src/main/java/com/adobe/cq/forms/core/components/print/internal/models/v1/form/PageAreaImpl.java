...
@Model(
    ...
    adapters = { PageArea.class, ComponentExporter.class },
    resourceType = { FormConstants.RT_FD_FORM_PAGEAREA_V1 })
@Exporter(
    name = ExporterConstants.SLING_MODEL_EXPORTER_NAME,
    extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class PageAreaImpl extends AbstractContainerImpl implements PageArea {
    @Override
    public String getFieldType() {
        return super.getFieldType(FieldType.PAGEAREA);
    }
}
