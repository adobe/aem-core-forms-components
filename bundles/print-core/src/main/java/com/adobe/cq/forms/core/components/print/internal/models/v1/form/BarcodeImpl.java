...
@Model(
    ...
    adapters = { Barcode.class, ComponentExporter.class },
    resourceType = { FormConstants.RT_FD_FORM_BARCODE_V1 })
@Exporter(
    name = ExporterConstants.SLING_MODEL_EXPORTER_NAME,
    extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class BarcodeImpl extends AbstractFormComponentImpl implements Barcode {
    @Override
    public String getFieldType() {
        return super.getFieldType(FieldType.BARCODE);
    }
}
