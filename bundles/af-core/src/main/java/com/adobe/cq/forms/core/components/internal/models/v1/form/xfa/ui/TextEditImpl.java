...
public class TextEditImpl implements TextEdit {
    ...
    @Override
    public String getAllowRichText() {
    ...
    public static TextEdit fromString(String val) {
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            return objectMapper.readValue(val, TextEditImpl.class);
