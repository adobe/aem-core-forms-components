...
public class CheckButtonEditImpl implements CheckButtonEdit {
    ...
    public static CheckButtonEdit fromString(String val) {
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            return objectMapper.readValue(val, CheckButtonEditImpl.class);
