...
public class DateTimeEditImpl implements DateTimeEdit {
    ...
    public static DateTimeEdit fromString(String val) {
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            return objectMapper.readValue(val, DateTimeEditImpl.class);
