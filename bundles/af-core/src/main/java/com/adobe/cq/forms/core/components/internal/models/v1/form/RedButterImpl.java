...
import com.adobe.cq.forms.core.components.models.form.RedButter;
import com.adobe.cq.forms.core.components.util.AbstractOptionsFieldImpl;
import com.fasterxml.jackson.annotation.JsonIgnore;

@Model(
    adaptables = { SlingHttpServletRequest.class, Resource.class },
    adapters = { RedButter.class,
        ComponentExporter.class },
    resourceType = { FormConstants.RT_FD_FORM_RED_BUTTER_V1 })
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class RedButterImpl extends AbstractOptionsFieldImpl implements RedButter {
    ...
    @PostConstruct
    private void initRedButtonModel() {
