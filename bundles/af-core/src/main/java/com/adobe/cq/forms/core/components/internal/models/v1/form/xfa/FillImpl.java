...
import com.adobe.cq.forms.core.components.models.form.xfa.Color;
...
public class FillImpl implements Fill {
    ...
    public static Fill fromString(String fill) {
        ObjectMapper objectMapper = new ObjectMapper();
        try {
            return objectMapper.readValue(fill, FillImpl.class);
