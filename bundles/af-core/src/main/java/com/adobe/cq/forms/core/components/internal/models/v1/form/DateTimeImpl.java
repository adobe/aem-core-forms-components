...
@Model(adaptables = { SlingHttpServletRequest.class, Resource.class }, adapters = { DateTime.class,
        ComponentExporter.class }, resourceType = { FormConstants.RT_FD_FORM_DATETIME_V1 })
