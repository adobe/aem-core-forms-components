 ...
 * API, without the actual implementation to support it. This can happen when an implementor migrates a <a href=
 * "https://helpx.adobe.com/experience-manager/core-components-v1/using/guidelines.html#ProxyComponentPattern">proxy
 * component </a> to a newer version of the core component it proxies and a custom Sling Model implementation,
