...
/**
 * Datasource servlet that returns Adobe Sign Block component names from the current form,
 * used to populate the "signFieldBlocks" and "signerAfFieldsBlock" dropdowns
...
public class AdobeSignFieldsDataSourceServlet extends AbstractDataSourceServlet {
    ...
    private SyntheticResource createDropdownEntry(ResourceResolver resourceResolver, String displayValue, String dataValue) {
