...
public class DropDownImplTest {
    ...
    void testGetEnumNames() {
        ...
        assertArrayEquals(new String[] { "m", "f", "o" }, dropdown.getEnumNamesArray());
    }
    ...
    void testGetEnumNamesWithDuplicateEnumValues() {
        ...
        assertArrayEquals(map.values().toArray(new String[0]), dropdown.getEnumNamesArray());
    }
    ...
    void testInsertionOrderForEnumNames() {
        ...
        assertArrayEquals(set.toArray(new String[0]), dropdown.getEnumNamesArray());
    }
}
