...
public class CheckBoxGroupImplTest {
    ...
    void testGetEnumNames() {
        ...
        assertArrayEquals(new String[] { "m", "f", "o" }, checkboxGroup.getEnumNamesArray());
    }
    ...
    void testGetEnumNamesWithDuplicateEnumValues() {
        ...
        assertArrayEquals(map.values().toArray(new String[0]), checkboxGroup.getEnumNamesArray());
    }
    ...
    void testInsertionOrderForEnumNames() {
        ...
        assertArrayEquals(set.toArray(new String[0]), checkboxGroup.getEnumNamesArray());
    }
}
