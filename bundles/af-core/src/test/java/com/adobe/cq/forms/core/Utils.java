...
public class Utils {
    ...
    public static void testSchemaValidation(@NotNull Object model) {
        ...
        try {
            InputStream schemaStream = Utils.class.getResourceAsStream("/schema/0.12.6/adaptive-form.schema.json");
            ...
            if (!(model instanceof FormContainerImpl)) {
                InputStream formContainerTemplate = Utils.class.getResourceAsStream("/schema/0.12.6/form.json");
