...
public class Utils {
    ...
    public static void testSchemaValidation(@NotNull Object model) {
        ...
        try {
            InputStream schemaStream = Utils.class.getResourceAsStream("/schema/0.13.1/adaptive-form.schema.json");
            ...
            if (!(model instanceof FormContainerImpl)) {
                InputStream formContainerTemplate = Utils.class.getResourceAsStream("/schema/0.13.1/form.json");
